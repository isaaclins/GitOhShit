...
const CommitTabList: React.FC<CommitTabListProps> = ({
  ...
  if (sortedCommits.length === 0) {
    return (
      <div className="commit-tab-list commit-tab-list--empty">
        <div className="commit-tab-list__empty-state">
          <p>No commits to display</p>
          {branchFilter && (
            <p className="commit-tab-list__empty-filter">
  ...
  return (
    <div className="commit-tab-list">
      <div className="commit-tab-list__header">
        <h3 className="commit-tab-list__title">
          Commits ({sortedCommits.length})
        </h3>
        {branchFilter && (
          <span className="commit-tab-list__filter">
            📍 {branchFilter}
          </span>
        )}
      </div>

      <div className="commit-tab-list__tabs">
